...
@Observable final class RuleChartViewModel {
    ...
    var averageNumberOfPermits: Double {
        return permits.reduce(0.0) { return $0 + $1.numberOfPermits/Double(permits.count) }
    }
}
